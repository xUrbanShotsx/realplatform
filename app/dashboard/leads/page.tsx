...
const LEADS = [
  { name: 'Tom & Lucy Gardiner', suburb: 'Searching: Cronulla',   score: 91, source: 'realestate.com.au', time: '14 min ago',  qualified: true,  budget: '$2.1M–$2.4M', type: 'Buyer',  status: 'HOT',    statusColor: RED,    message: 'Looking for 4-bed beachside — pre-approved $2.3M. Attended 3 opens last weekend. Very motivated.' },
  { name: 'Felicia Rosario',      suburb: 'Selling: Gymea Bay',    score: 84, source: 'Website',          time: '32 min ago',  qualified: true,  budget: '$1.4M+',      type: 'Seller', status: 'WARM',   statusColor: AMBER,  message: 'Filled out "What\'s my home worth?" form. 4-bed in Gymea Bay. Wants call this week.' },
  { name: 'James Wu',             suburb: 'Investing: Sutherland', score: 79, source: 'Referral',         time: '1 hr ago',    qualified: true,  budget: '$800K–$1.1M', type: 'Investor',status: 'WARM',   statusColor: AMBER,  message: 'Referred by Michael Tran. Looking for high-yield rental. Has 2 existing IPs.' },
  { name: 'Unknown Caller',       suburb: 'Shell Cove',            score: 61, source: 'Direct',           time: '2 hrs ago',   qualified: false, budget: 'Unknown',     type: 'Seller', status: 'NEW',    statusColor: BLUE,   message: 'Inbound call — left voicemail. Property at Shell Cove. AI Chatbot engaged and gathering info.' },
  { name: 'Rachel Obi',           suburb: 'Searching: Bexley',     score: 72, source: 'Social',           time: '3 hrs ago',   qualified: false, budget: '$900K–$1.2M', type: 'Buyer',  status: 'NEW',    statusColor: BLUE,   message: 'Instagram DM — "Do you have anything in Bexley under $1.2M with a granny flat?" AI responded.' },
  { name: 'Domain Portal Enquiry',suburb: 'Viewing 42 Foreshore',  score: 55, source: 'Domain',           time: '4 hrs ago',   qualified: false, budget: 'Enquiring',   type: 'Buyer',  status: 'NEW',    statusColor: BLUE,   message: 'Enquired on 42 Foreshore Cres. AI Chatbot: "Can we book a private inspection?" — follow-up due.' },
  { name: 'Paul & Deborah Starr', suburb: 'Selling: Caringbah',    score: 88, source: 'Rate My Agent',    time: 'Yesterday',   qualified: true,  budget: '$1.8M+',      type: 'Seller', status: 'WARM',   statusColor: AMBER,  message: 'Found us from 5★ review. Thinking of selling their 5-bed. Waiting for market update.' },
]
